...
== Changelog ==
= 3.0.3 =
* Update - PHP Versiyon farklılıkları giderildi.
* Update - Block tasarımı ile ilgili güncellemeler yapıldı.

= 3.0.2 =
* Update - Eski PHP Versiyonları ile ilgili güncellemeler yapıldı.

= 3.0.1 =
* Update - PHP Versiyon güncellemesi yapıldı.

= 3.0.0 =
* Update - iFrame API ve Havale / EFT eklentimiz tek bir eklenti halinde yönetilebilir hale getirilmiştir.
* Update - Wordpress ve WooCommerce sürümlerinden kaynaklı hatalar giderilmiştir.
* Update - High-Performance Order Storage (HPOS) desteği eklenmiştir.
* Update - WooCommerce Checkout (Blok tasarımlı ödeme sayfası) uyumlu hale getirilmiştir.
* Update - Performans iyileştirmeleri sağlandı.
